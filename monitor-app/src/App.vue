  ...
  return [
    {
      ...
      unit: '°C',
      icon: '🌡️',
      color: getTemperatureColor(sensorData.value.temperature),
    },
    {
      key: 'humidity',
      title: 'Umidade',
      value: sensorData.value.humidity.toFixed(1),
      unit: '%',
      icon: '💧',
      color: '#3498db',
    },
    ...
    },
    {
      key: 'tolueno',
      title: 'Tolueno',
      value: sensorData.value.tolueno.toFixed(2),
      unit: 'ppm',
      icon: '🧪',
      color: '#9b59b6',
    },
    {
      key: 'amonia',
      title: 'Amônia',
      value: sensorData.value.amonia.toFixed(2),
      unit: 'ppm',
      icon: '⚗️',
      color: '#e67e22',
    },
    {
      key: 'acetona',
      title: 'Acetona',
      value: sensorData.value.acetona.toFixed(2),
      unit: 'ppm',
      icon: '🔬',
      color: '#1abc9c',
    },
    {
      key: 'ozonio',
      title: 'Ozônio',
      value: sensorData.value.ozonio.toFixed(3),
      unit: 'ppm',
      icon: '☁️',
      color: '#3498db',
    },
